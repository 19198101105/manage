<template>
    <el-row class="home" :gutter="15">
        <el-col :span="8" style="margin-top:8px">
            ...
            <el-card style="margin-top:10px;height:380px;">
        ...
        <el-col style="margin-top:8px" :span="16">
            <div class="num">
            ...
            <el-card style="height:215px">
                <div style="height: 215px" ref="echarts"></div>
            </el-card>
            <div class="graph">
...
export default {
    ...
    data() {
        return {
            userImg: require('../../src/assets/images/2.png'),
            tableData: [
                {
                    name: '化妆品',
                    todayBuy: 700,
