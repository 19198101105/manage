    ...
    <div class="manage">
        ...
        <div class="manage-header">
            ...
            <common-form :formLabel="formLabel" :form="searchFrom" :inline="true" ref="form">
                <el-button type="primary" @click="getList(formLabel[0].model)">搜索</el-button>
            </common-form>
        </div>
...
export default {
    ...
    methods: {
        confirm() {
          ...
          const paramsName =  ['name','age','sex','birth','addr']
         paramsName.forEach((item,index)=>{
            this.operateForm[item] = this.operateFormLabel[index].model
          })
